...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getCompanyNames: function getCompanyNames() {
      ...
      axios.get('/api/v1/bedrijven/namen', {}).then(function (response) {
    ...
    search: function search() {
      ...
      axios.get(url, {
        ...
        _this4.contactpersons = response.data.data;
    ...
    destroy: function destroy(contactperson) {
      ...
      axios["delete"](url).then(function (response) {
        Event.$emit('alertApplied');
        _this5.alertMessage = response.data.message;
        _this5.alertType = response.data.type;
    ...
    onSubmitEdit: function onSubmitEdit() {
      ...
      if (this.createForm === true) {
        this.editForm.post('/api/v1/contactpersonen').then(function (response) {
          _this6.closeEditForm();

          _this6.alertMessage = response.message;
          _this6.alertType = response.type;
          Event.$emit('alertApplied');

          _this6.getContactpersons();
        })["catch"](function (e) {
      ...
      _vm.users.length
        ? _c("div", { staticClass: "row" }, [
            _c("div", { staticClass: "col-md-8" }, [
              _c("div", { staticClass: "card mb-5 shadow rounded" }, [
                _vm._m(0),
                _vm._v(" "),
                    ...
                    _vm._l(_vm.companies, function(company) {
                      return _c("div", { key: company.id }, [
                        _c(
                          ...
                          {
                            staticClass:
                              "card mb-5 ml-2 mr-2 flex-fill shadow rounded"
                          },
                          [
                            _c("div", { staticClass: "card-header mb-1" }, [
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      ...
      [
        _c("h5", { staticClass: "font-weight-bold py-1 my-0 text-muted" }, [
          _vm._v("Bedrijven")
        ])
      ]
    )
    ...
    _c("div", { staticClass: "row justify-content-center" }, [
      _c(
        ...
        [
          ...
          _vm._v(" "),
          _c("div", { staticClass: "card mb-5 ml-2 mr-2 shadow rounded" }, [
                      ...
                      _vm._l(_vm.contactpersons, function(contactperson) {
                        return _c("tr", { key: contactperson.id }, [
                          ...
                          _c(
                            ...
                            { staticStyle: { "vertical-align": "middle" } },
                            [
                              contactperson.company.id !== null
                                ? _c("span", { staticClass: "text-primary" }, [
                                    _vm._v(
                                      "\n                                Werkt bij " +
                                        _vm._s(contactperson.company.name) +
                                        "\n                                "
                                    )
                                  ])
                                : _vm._e(),
    ...
    _c(
      ...
      [
        ...
        _c("div", { staticClass: "col-md-10" }, [
          _c("div", { staticClass: "card mb-5 ml-1 mr-2 shadow rounded" }, [
            _c("div", { staticClass: "card-header" }, [
              _c("div", { staticClass: "row justify-content-around" }, [
                _vm._m(1),
                _vm._v(" "),
